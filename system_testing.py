...
if __name__ == "__main__":
    ...
    parser.add_argument('-b', '--branch', help="preCICE branch to use", default='develop')  # make sure that branch corresponding to system tests branch is used, if no branch is explicitly specified. If we are testing a pull request, make sure to test agains branch from which PR originated.
